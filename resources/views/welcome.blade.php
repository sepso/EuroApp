                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="team-player">
                                    <img src="{{ asset('/MK_BS3/img/avatar.jpg') }}" alt="Thumbnail Image" class="img-raised img-circle">
                            ...
                            <div class="col-md-4">
                                <div class="team-player">
                                    <img src="{{ asset('/MK_BS3/img/christian.jpg') }}" alt="Thumbnail Image" class="img-raised img-circle">
                            ...
                            <div class="col-md-4">
                                <div class="team-player">
                                    <img src="{{ asset('/MK_BS3/img/kendall.jpg') }}" alt="Thumbnail Image" class="img-raised img-circle">
